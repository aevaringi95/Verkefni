...
lev = levels(data$teg_eign)[c(1,2,7,8,10,11)] 
...
Let's plot nuvirdi against some variables. 
...
## Linear Regression
Getum gert einhverja aðra aðferð, vildi bara prófa. 
